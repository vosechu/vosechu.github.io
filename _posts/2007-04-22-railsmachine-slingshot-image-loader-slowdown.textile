...
Mongrel is terrible at serving images and static content from the filesystem. In the words of Zed Shaw, "This means mongrel will serve images, javascript, files, and everything else. Itâ€™s quite fast at this, but Apache can do it better."
